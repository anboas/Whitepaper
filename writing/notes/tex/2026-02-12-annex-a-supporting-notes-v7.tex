...
% Purpose: feed ACP-RA design + DAD memo with ontologically grouped evidence
% =========================================================
...
\newcommand{\PaperSubtitle}{An Ontologically Structured Research Synthesis for ACP-RA and the Delegated Autonomy Directorate}
...
\renewcommand{\DocVersion}{v7-draft}
...
\begin{execsummary}
\textbf{Purpose.} Re-architect the supporting research into an ontology-grounded paper that preserves narrative coherence while grouping evidence by topic.

\textbf{Central claim.} The decisive variable in next-generation conflict is governed delegation throughput under contested conditions. Model quality is necessary but insufficient.

\textbf{Design implication.} ACP must function as mission-control infrastructure, not an application accessory.

\textbf{Organizational implication.} DAD should be empowered as the institutional authority that enforces trust scope, runtime controls, evidence standards, and no-conformance/no-scale rules.
\end{execsummary}
