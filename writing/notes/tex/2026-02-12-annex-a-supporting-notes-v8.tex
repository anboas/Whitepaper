...
% Purpose: feed ACP-RA design + DAD memo with cohesive topic-grouped evidence
% =========================================================
\documentclass[11pt]{article}

% Shared styling/preamble (paper-format consistency)
% Tectonic/XeTeX compatibility shim for preamble's pdfTeX-only metadata hook.
...
\newcommand{\PaperSubtitle}{A Comprehensive Research Synthesis for ACP-RA and the Delegated Autonomy Directorate}
...
\renewcommand{\DocVersion}{v8-draft}
...
\begin{execsummary}
\textbf{Purpose.} Provide a cohesive research paper on why delegated autonomy now requires mission-control architecture and institutional authority.

\textbf{Central claim.} The strategic bottleneck is no longer model intelligence in isolation. It is governed delegation throughput under contested conditions.

\textbf{Design implication.} ACP should be treated as command infrastructure: authority scoping, policy enforcement, provenance, resilience, and rollback must be native design properties.

\textbf{Institutional implication.} DAD should be empowered to set and enforce trust boundaries, evidence standards, and scale gates across mission domains.
\end{execsummary}
...
\subsection{12) Policy/operational source
...
\subsection{13) Academic source library
