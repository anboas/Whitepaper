...
% Purpose: evidence-extracted research synthesis for ACP-RA + DAD
% =========================================================
...
\newcommand{\PaperSubtitle}{Evidence-Extracted Research Synthesis for ACP-RA and the Delegated Autonomy Directorate}
...
\renewcommand{\DocVersion}{v9-draft}
\begin{document}
\thispagestyle{empty}
\vspace*{0.6in}
...
\newpage
\begin{execsummary}
\textbf{Purpose.} Build a research-grade synthesis where each topic includes thesis, extracted evidence, analytical summary, and deductions.

\textbf{Current state.} This revision introduces source-level evidence extraction and topic-by-topic synthesis to support iterative hardening into publication-quality argumentation.

\textbf{Implication for ACP-RA.} The control plane should be treated as warfighting infrastructure for governed delegation, provenance, and resilience under contested conditions.

\textbf{Implication for DAD.} Institutional authority should be tied to explicit evidence standards, scaling gates, and recurring adversarial validation.
\end{execsummary}
...
deployment constraints requiring explicit mitigation. {[}32{]} - NATO's
revised strategy also flags compute intensity, energy demand, and
associated governance implications as alliance-level concerns. {[}40{]}
