...
\textbf{Composition rule:} when scopes combine (agent\ensuremath{\rightarrow}agent,
agent\ensuremath{\rightarrow}ensemble, cross-enclave), authority composes by
...
\item
  ...
  scope)
\item
  evidence drill-down by work\_unit\_id (macro\ensuremath{\rightarrow}meso\ensuremath{\rightarrow}micro replay tiers)
\item
...
\tightlist
\item
  shadow \ensuremath{\rightarrow} canary \ensuremath{\rightarrow} promote \ensuremath{\rightarrow} rollback
\item
...
\item
  replay: reconstructing intent \ensuremath{\rightarrow} context \ensuremath{\rightarrow} decision \ensuremath{\rightarrow} action \ensuremath{\rightarrow} outcome
\item
  continuous authorization: evidence inside the system boundary
\end{itemize}

\hypertarget{lineage-graph-data-logic-action-artifact}{%
\subsubsection{Lineage Graph (Data \ensuremath{\rightarrow} Logic \ensuremath{\rightarrow} Action \ensuremath{\rightarrow} Artifact)}\label{lineage-graph-data-logic-action-artifact}}
...
\subsection{Action Loop: Intent \ensuremath{\rightarrow} Policy \ensuremath{\rightarrow} Mediated Action \ensuremath{\rightarrow} Evidence}\label{action-loop-intent-policy-mediated-action-evidence}}
...
\subsection{Governance Loop: Artifacts \ensuremath{\rightarrow} Tests \ensuremath{\rightarrow} Promotion \ensuremath{\rightarrow} Enforcement}\label{governance-loop-artifacts-tests-promotion-enforcement}}
...
\tightlist
\item
  \textbf{Hierarchical (orchestrator \ensuremath{\rightarrow} workers):} orchestrator
...
\item
  ...
  revocation channels
\item
  replay drills: reconstruct ensemble failures using macro\ensuremath{\rightarrow}meso\ensuremath{\rightarrow}micro
  evidence tiers
\end{itemize}
...
\item
  model/tool update cycle time (shadow \ensuremath{\rightarrow} canary \ensuremath{\rightarrow} promote \ensuremath{\rightarrow} rollback)
\item
...
\item
  cascade containment time (detect \ensuremath{\rightarrow} throttle \ensuremath{\rightarrow} isolate)
\item
...
\item
  anomaly response time (detect \ensuremath{\rightarrow} contain)
\end{itemize}
...
\subsection{Transition Roadmap (Copilots \ensuremath{\rightarrow} Governed Agents \ensuremath{\rightarrow} Supervised Autonomy \ensuremath{\rightarrow} Governed Swarms)}\label{transition-roadmap-copilots-governed-agents-supervised-autonomy-governed-swarms}}
