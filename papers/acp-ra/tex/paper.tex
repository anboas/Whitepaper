...
\textbf{Ensemble evidence (always-on, lightweight):} - coordination graph metadata (A2A edges by type and time). - arbitration outcomes (conflicts, quorums, deadlocks/timeouts). - budget burn-down time series (aggregate and per-role). - work-unit DAG summaries (dependencies, blocks, cancellations).
...
\textbf{Dashboards} - coordination graph (A2A edges by type over time; fan-out heatmap). - arbitration events (conflicts, quorums, leader changes, deadlocks/timeouts). - budget burn-down (aggregate + per-role + anomaly overlays). - ensemble drift (distribution shifts across actions/plans). - work-unit DAG health (dependency blocks, repeated stalls). - containment posture (quarantined members, degraded mode active, policy lockdown status).
...
\subsection{DoD / DoD CIO}\label{dod-dod-cio}}

\begin{itemize}
\tightlist
\item
  DoD CIO, \emph{Reference Architecture Description} (June 2010): https://dodcio.defense.gov/Portals/0/Documents/Ref\_Archi\_Description\_Final\_v1\_18Jun10.pdf.
\item
  DoD CIO, \emph{DoD Zero Trust Reference Architecture v2.0} (2022): https://dodcio.defense.gov/Portals/0/Documents/Library/\%28U\%29ZT\_RA\_v2.0\%28U\%29\_Sep22.pdf.
\item
  DoD CIO, \emph{ICAM Federation Framework} (2024): https://dodcio.defense.gov/Portals/0/Documents/Cyber/ICAM-FederationFramework.pdf.
\item
  DoD CIO, \emph{Cloud Native Access Point (CNAP) Reference Design v1.0} (2021): https://dodcio.defense.gov/Portals/0/Documents/Library/CNAP\_RefDesign\_v1.0.pdf.
\item
  DoD CIO, \emph{DevSecOps Continuous Authorization Implementation Guide} (2024): https://dodcio.defense.gov/Portals/0/Documents/Library/DoDCIO-ContinuousAuthorizationImplementationGuide.pdf.
\item
  DoD CIO, \emph{cATO Evaluation Criteria} (2024): https://dodcio.defense.gov/Portals/0/Documents/Library/cATO-EvaluationCriteria.pdf.
\item
  DoD CIO, \emph{Continuous Authorization to Operate (cATO) memo} (2022): https://media.defense.gov/2022/Feb/03/2002932852/-1/-1/0/Continuous-Authorization-TO-Operate.PDF.
\item
  DoD CIO, \emph{AI Cybersecurity Risk Management Tailoring Guide} (2025): https://dodcio.defense.gov/Portals/0/Documents/Library/AI-CybersecurityRMTailoringGuide.pdf.
\item
  DoD, \emph{Implementing Responsible AI in the DoD} (May 2021): https://media.defense.gov/2021/May/27/2002730593/-1/-1/0/Implementing-Responsible-Artificial-Intelligence-IN-the-Department-OF-Defense.PDF.
\item
  DoD, \emph{Responsible AI Strategy and Implementation Pathway} (June 2022): https://media.defense.gov/2022/Jun/22/2003022604/-1/-1/0/Department-of-Defense-Responsible-Artificial-Intelligence-Strategy-and-Implementation-Pathway.PDF.
\item
