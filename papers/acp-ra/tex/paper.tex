...
\begin{figure}[h]
  ...
  \caption{Agent Control Plane OV-1 (Color-Coded, Outline-First). Outline colors distinguish existing enterprise baseline (gray), ACP-RA control-plane components (blue), and runtime execution layer integration (green).}
  \label{fig:acp-ov1}
\end{figure}
