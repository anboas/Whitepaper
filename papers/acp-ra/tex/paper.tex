...
\begin{figure}[h]
  ...
  \caption{Agent Control Plane OV-1 (Color-Coded, Outline-First). Key: gray = already existing enterprise baseline, blue = ACP-RA control-plane components, green = runtime execution layer integrated by ACP-RA.}
  \label{fig:acp-ov1}
\end{figure}
