...
\vfill
% Metadata footer (keep readable in both PDF and pandoc HTML)
\noindent\textcolor{BrandGray}{\small\textbf{Distribution:} Public.}\par
\noindent\textcolor{BrandGray}{\small\textbf{Disclaimer:} Views are the author's and do not represent official policy.}
\newpage
