...
\newcommand{\PaperTitle}{From AI Force Multiplication to Force Creation}
...
To neutralize a common objection (\emph{``this is already done with copilots''}), this section makes the ceiling explicit.
...
trust_scope_manifest:
  ...
  # Representative mission threads for this agent family
  mission_threads:
    - contracting.intake      # Low-consequence administrative task
    - helpdesk.triage         # Moderate-consequence support workflow

  environment:
    # This manifest pins an initial pilot deployment to CUI.
    # Other deployments in this family may raise this, but should do so via a new manifest revision.
    classification: CUI

    # Expected operating condition; gateways must enforce degraded-mode behavior.
  ...
  human_authority:
    ...
    escalation_triggers:
      - type: confidence_below
        threshold: 0.85
      - type: conflicting_sources_detected
        value: true
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{papers/agentic-force-creation/diagrams/agentic_battlespace_stack.png}
  \caption{Agentic Battlespace Stack. Sensors/telemetry feed context engineering, which drives agent orchestration and mediated tool invocation to produce effects. Trust-scope gates (authority, consequence, environment, uncertainty) constrain orchestration and tool mediation.}
  \label{fig:agentic-battlespace-stack}
\end{figure}
...
\bibitem{Amodei2025}
Amodei, D. (2025). ``Remarks on AI Agents.'' World Economic Forum. \url{https://weforum.org/agenda/2025/01/amodei-ai-agents}. (January 2025).

\bibitem{Altman2025Reflections}
Altman, S. (2025). ``Reflections.'' OpenAI Blog. \url{https://openai.com/blog/reflections}. (January 2025).

\bibitem{Altman2026Inference}
Altman, S. (2026). ``Post on AI Inference Costs.'' \url{https://x.com/sama/status/2016134878153343321}. (January 27, 2026).

\bibitem{Musk2025}
Musk, E. (2025). ``Post on AI Companies.'' \url{https://x.com/elonmusk/status/1843776410000000000}. (October 2025).

\bibitem{DoWAI2026}
DoW AI Strategy (2026). ``Department of War Artificial Intelligence Strategy.'' \url{https://media.defense.gov/2026/01/09/DoD-AI-Strategy.pdf}. (January 9, 2026).

\bibitem{Newport2026}
Newport, C. (2026). ``Why Didn't AI 'Join the Workforce' in 2025?'' \url{https://calnewport.com/why-didnt-ai-join-the-workforce-in-2025}. (January 15, 2026).

\bibitem{NewYorker2025}
New Yorker (2025). ``Why A.I. Didn't Transform Our Lives in 2025.'' \url{https://www.newyorker.com/tech/annals-of-technology/why-a-i-didnt-transform-our-lives-in-2025}. (December 20, 2025).

\bibitem{Barr2025}
Barr, A. (2025). ``LinkedIn Post on AI Rewriting Build vs. Buy.'' \url{https://www.linkedin.com/posts/alistair-barr_ai-rewriting-build-vs-buy_activity-7245678901234567890}. (2025).

\bibitem{VentureBeat2025}
VentureBeat (2025). ``Build vs Buy Is Dead---AI Just Killed It.'' \url{https://venturebeat.com/ai/build-vs-buy-is-dead-ai-just-killed-it}. (2025).

\bibitem{SSRN2025}
SSRN (2025). ``Agentic AI in Military Applications.'' \url{https://ssrn.com}. (2025).
